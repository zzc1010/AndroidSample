...
public class PasswordUtils {
    ...
    private String encrypt() throws IOException {
        System.out.println("PasswordUtils_encrypt");
        String ret = null;
    ...
    PasswordUtils(String aPassword) {
        System.out.println("PasswordUtils_constructor");
    ...
    private String decrypt() throws IOException {
        System.out.println("PasswordUtils_decrypt");
        String ret = null;
        try {
